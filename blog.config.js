...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '76c4cc842b8746cd99db01e911eda570',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '鸿泽机械', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '专业印刷包装设备改造/销售', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.hongzejx.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '分切机, 复合机,印刷机,制袋机,干式复合机,凹版印刷机,二手分切机,二手凹版印刷机,二手复合机,二手干式复合机,二手制袋机,塑料包装设备', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '鲁ICP备2023016880号', // 备案号 闽ICP备XXXXXXX
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://hzjx.vercel.app', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '18906824', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '专业印刷包装设备改造翻新', // 站点描述，被notion中的页面描述覆盖
